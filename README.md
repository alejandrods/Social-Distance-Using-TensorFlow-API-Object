# Social Distance Using TensorFlow API Object Detection
We are going to use the Tensorflow API Object Recognition to detect persons and calculate the distance between them. I have used the `SSD with Mobilenet` model and I created some functions to improve the visualization of our predictions.
